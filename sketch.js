...
function setup() {
  ...
  block15 = new Block(490,300,30,40);  
  block16 = new Block(520,300,30,40);
  block17= new Block(550,300,30,40);
  block18= new Block(580,300,30,40);
  block19= new Block(610,300,30,40);
  block20= new Block(640,300,30,40);
  block21= new Block(670,250,30,40);
  block22= new Block(700,250,30,40);
  block23= new Block(730,250,30,40);
  block24 = new Block(760,250,30,40);
  block25 = new Block(790,250,30,40);
  block26 = new Block(810,250,30,40);
  block27 = new Block(840,215,30,40);
  block28 = new Block(470,215,30,40);


  monster = new Monster(400,300,100,100);
